...
function remove_min_binding_1(param) do
  if (param) then do
    l = param[--[[ l ]]1];
    if (l) then do
      return bal_1(remove_min_binding_1(l), param[--[[ v ]]2], param[--[[ d ]]3], param[--[[ r ]]4]);
    end else do
      return param[--[[ r ]]4];
    end end 
  end else do
...
function mapi_1(f, param) do
  if (param) then do
    v = param[--[[ v ]]2];
    l_prime = mapi_1(f, param[--[[ l ]]1]);
    d_prime = Curry._2(f, v, param[--[[ d ]]3]);
    r_prime = mapi_1(f, param[--[[ r ]]4]);
    return --[[ Node ]]{
            --[[ l ]]l_prime,
            --[[ v ]]v,
            --[[ d ]]d_prime,
...
function fold_1(f, _m, _accu) do
  while(true) do
    ...
    m = _m;
    if (m) then do
      _accu = Curry._3(f, m[--[[ v ]]2], m[--[[ d ]]3], fold_1(f, m[--[[ l ]]1], accu));
      _m = m[--[[ r ]]4];
      ::continue:: ;
    end else do
      return accu;
...
function for_all_1(p, _param) do
  while(true) do
    param = _param;
    if (param) then do
      if (Curry._2(p, param[--[[ v ]]2], param[--[[ d ]]3]) and for_all_1(p, param[--[[ l ]]1])) then do
        _param = param[--[[ r ]]4];
        ::continue:: ;
      end else do
        return false;
...
function exists_1(p, _param) do
  while(true) do
    param = _param;
    if (param) then do
      if (Curry._2(p, param[--[[ v ]]2], param[--[[ d ]]3]) or exists_1(p, param[--[[ l ]]1])) then do
        return true;
      end else do
        _param = param[--[[ r ]]4];
        ::continue:: ;
...
function add_min_binding_1(k, x, param) do
  if (param) then do
    return bal_1(add_min_binding_1(k, x, param[--[[ l ]]1]), param[--[[ v ]]2], param[--[[ d ]]3], param[--[[ r ]]4]);
  end else do
...
function add_max_binding_1(k, x, param) do
  if (param) then do
    return bal_1(param[--[[ l ]]1], param[--[[ v ]]2], param[--[[ d ]]3], add_max_binding_1(k, x, param[--[[ r ]]4]));
  end else do
    return singleton_1(k, x);
  end end 
end end
...
function join_1(l, v, d, r) do
  if (l) then do
    if (r) then do
      ...
      lh = l[--[[ h ]]5];
      if (lh > (rh + 2 | 0)) then do
        return bal_1(l[--[[ l ]]1], l[--[[ v ]]2], l[--[[ d ]]3], join_1(l[--[[ r ]]4], v, d, r));
      end else if (rh > (lh + 2 | 0)) then do
        return bal_1(join_1(l, v, d, r[--[[ l ]]1]), r[--[[ v ]]2], r[--[[ d ]]3], r[--[[ r ]]4]);
      end else do
...
function merge_3(f, s1, s2) do
  if (s1) then do
    v1 = s1[--[[ v ]]2];
    if (s1[--[[ h ]]5] >= height_1(s2)) then do
      match = split_1(v1, s2);
      return concat_or_join_1(merge_3(f, s1[--[[ l ]]1], match[1]), v1, Curry._3(f, v1, Caml_option.some(s1[--[[ d ]]3]), match[2]), merge_3(f, s1[--[[ r ]]4], match[3]));
    end
     end 
  end else if (not s2) then do
    return --[[ Empty ]]0;
  ...
  if (s2) then do
    ...
    return concat_or_join_1(merge_3(f, match_1[1], s2[--[[ l ]]1]), v2, Curry._3(f, v2, match_1[2], Caml_option.some(s2[--[[ d ]]3])), merge_3(f, match_1[3], s2[--[[ r ]]4]));
  end else do
    error({
      Caml_builtin_exceptions.assert_failure,
      --[[ tuple ]]{
  ...
  if (s1) then do
    if (s2) then do
      ...
      if (s1[--[[ h ]]5] >= s2[--[[ h ]]5]) then do
        match = split_1(v1, s2);
        d2_1 = match[2];
        l = union_1(f, s1[--[[ l ]]1], match[1]);
        r = union_1(f, s1[--[[ r ]]4], match[3]);
        if (d2_1 ~= nil) then do
        ...
        match_1 = split_1(v2, s1);
        d1_1 = match_1[2];
        l_1 = union_1(f, match_1[1], s2[--[[ l ]]1]);
        r_1 = union_1(f, match_1[3], s2[--[[ r ]]4]);
        if (d1_1 ~= nil) then do
...
function filter_1(p, m) do
  if (m) then do
    ...
    v = m[--[[ v ]]2];
    l = m[--[[ l ]]1];
    l_prime = filter_1(p, l);
    pvd = Curry._2(p, v, d);
    r_prime = filter_1(p, r);
    if (pvd) then do
      if (l == l_prime and r == r_prime) then do
        return m;
      end else do
...
function partition_1(p, param) do
  if (param) then do
    d = param[--[[ d ]]3];
    v = param[--[[ v ]]2];
    match = partition_1(p, param[--[[ l ]]1]);
    lf = match[2];
    lt = match[1];
    pvd = Curry._2(p, v, d);
    match_1 = partition_1(p, param[--[[ r ]]4]);
    rf = match_1[2];
    rt = match_1[1];
    if (pvd) then do
      return --[[ tuple ]]{
...
function cardinal_1(param) do
  if (param) then do
    return (cardinal_1(param[--[[ l ]]1]) + 1 | 0) + cardinal_1(param[--[[ r ]]4]) | 0;
  end else do
    return 0;
  end end 
end end
  ...
  if (hl > (hr + 2 | 0)) then do
    if (l) then do
      ...
      if (height_2(ll) >= height_2(lr)) then do
        ...
        return create_2(create_2(ll, lv, ld, lr[--[[ l ]]1]), lr[--[[ v ]]2], lr[--[[ d ]]3], create_2(lr[--[[ r ]]4], x, d, r));
      end else do
        error({
          Caml_builtin_exceptions.invalid_argument,
          "Map.bal"
    ...
    if (r) then do
      ...
      if (height_2(rr) >= height_2(rl)) then do
        ...
        return create_2(create_2(l, x, d, rl[--[[ l ]]1]), rl[--[[ v ]]2], rl[--[[ d ]]3], create_2(rl[--[[ r ]]4], rv, rd, rr));
      end else do
        error({
          Caml_builtin_exceptions.invalid_argument,
          "Map.bal"
...
function remove_min_binding_2(param) do
  if (param) then do
    l = param[--[[ l ]]1];
    if (l) then do
      return bal_2(remove_min_binding_2(l), param[--[[ v ]]2], param[--[[ d ]]3], param[--[[ r ]]4]);
    end else do
      return param[--[[ r ]]4];
    end end 
  end else do
...
function merge_4(t1, t2) do
  if (t1) then do
    if (t2) then do
      ...
      return bal_2(t1, match[1], match[2], remove_min_binding_2(t2));
    end else do
      return t1;
    end end 
  end else do
...
function map_2(f, param) do
  if (param) then do
    l_prime = map_2(f, param[--[[ l ]]1]);
    d_prime = Curry._1(f, param[--[[ d ]]3]);
    r_prime = map_2(f, param[--[[ r ]]4]);
    return --[[ Node ]]{
            --[[ l ]]l_prime,
            --[[ v ]]param[--[[ v ]]2],
            --[[ d ]]d_prime,
...
function mapi_2(f, param) do
  if (param) then do
    v = param[--[[ v ]]2];
    l_prime = mapi_2(f, param[--[[ l ]]1]);
    d_prime = Curry._2(f, v, param[--[[ d ]]3]);
    r_prime = mapi_2(f, param[--[[ r ]]4]);
    return --[[ Node ]]{
            --[[ l ]]l_prime,
            --[[ v ]]v,
            --[[ d ]]d_prime,
...
function fold_2(f, _m, _accu) do
  while(true) do
    ...
    m = _m;
    if (m) then do
      _accu = Curry._3(f, m[--[[ v ]]2], m[--[[ d ]]3], fold_2(f, m[--[[ l ]]1], accu));
      _m = m[--[[ r ]]4];
      ::continue:: ;
    end else do
      return accu;
...
function for_all_2(p, _param) do
  while(true) do
    param = _param;
    if (param) then do
      if (Curry._2(p, param[--[[ v ]]2], param[--[[ d ]]3]) and for_all_2(p, param[--[[ l ]]1])) then do
        _param = param[--[[ r ]]4];
        ::continue:: ;
      end else do
        return false;
...
function exists_2(p, _param) do
  while(true) do
    param = _param;
    if (param) then do
      if (Curry._2(p, param[--[[ v ]]2], param[--[[ d ]]3]) or exists_2(p, param[--[[ l ]]1])) then do
        return true;
      end else do
        _param = param[--[[ r ]]4];
        ::continue:: ;
...
function add_min_binding_2(k, x, param) do
  if (param) then do
    return bal_2(add_min_binding_2(k, x, param[--[[ l ]]1]), param[--[[ v ]]2], param[--[[ d ]]3], param[--[[ r ]]4]);
  end else do
...
function add_max_binding_2(k, x, param) do
  if (param) then do
    return bal_2(param[--[[ l ]]1], param[--[[ v ]]2], param[--[[ d ]]3], add_max_binding_2(k, x, param[--[[ r ]]4]));
  end else do
    return singleton_2(k, x);
  end end 
end end
...
function join_2(l, v, d, r) do
  if (l) then do
    if (r) then do
      ...
      lh = l[--[[ h ]]5];
      if (lh > (rh + 2 | 0)) then do
        return bal_2(l[--[[ l ]]1], l[--[[ v ]]2], l[--[[ d ]]3], join_2(l[--[[ r ]]4], v, d, r));
      end else if (rh > (lh + 2 | 0)) then do
        return bal_2(join_2(l, v, d, r[--[[ l ]]1]), r[--[[ v ]]2], r[--[[ d ]]3], r[--[[ r ]]4]);
      end else do
...
function concat_2(t1, t2) do
  if (t1) then do
    if (t2) then do
      match = min_binding_2(t2);
      return join_2(t1, match[1], match[2], remove_min_binding_2(t2));
    end else do
      return t1;
    end end 
  end else do
  ...
  if (param) then do
    ...
    if (c == 0) then do
      ...
      return --[[ tuple ]]{
              match[1],
              match[2],
              join_2(match[3], v, d, r)
            };
    end else do
      match_1 = split_2(x, r);
      return --[[ tuple ]]{
              join_2(l, v, d, match_1[1]),
              match_1[2],
              match_1[3]
            };
    end end  end 
...
function merge_5(f, s1, s2) do
  if (s1) then do
    v1 = s1[--[[ v ]]2];
    if (s1[--[[ h ]]5] >= height_2(s2)) then do
      match = split_2(v1, s2);
      return concat_or_join_2(merge_5(f, s1[--[[ l ]]1], match[1]), v1, Curry._3(f, v1, Caml_option.some(s1[--[[ d ]]3]), match[2]), merge_5(f, s1[--[[ r ]]4], match[3]));
    end
     end 
  end else if (not s2) then do
    return --[[ Empty ]]0;
  ...
  if (s2) then do
    ...
    return concat_or_join_2(merge_5(f, match_1[1], s2[--[[ l ]]1]), v2, Curry._3(f, v2, match_1[2], Caml_option.some(s2[--[[ d ]]3])), merge_5(f, match_1[3], s2[--[[ r ]]4]));
  end else do
    error({
      Caml_builtin_exceptions.assert_failure,
      --[[ tuple ]]{
  ...
  if (s1) then do
    if (s2) then do
      ...
      if (s1[--[[ h ]]5] >= s2[--[[ h ]]5]) then do
        match = split_2(v1, s2);
        d2_1 = match[2];
        l = union_2(f, s1[--[[ l ]]1], match[1]);
        r = union_2(f, s1[--[[ r ]]4], match[3]);
        if (d2_1 ~= nil) then do
        ...
        match_1 = split_2(v2, s1);
        d1_1 = match_1[2];
        l_1 = union_2(f, match_1[1], s2[--[[ l ]]1]);
        r_1 = union_2(f, match_1[3], s2[--[[ r ]]4]);
        if (d1_1 ~= nil) then do
...
function filter_2(p, m) do
  if (m) then do
    ...
    v = m[--[[ v ]]2];
    l = m[--[[ l ]]1];
    l_prime = filter_2(p, l);
    pvd = Curry._2(p, v, d);
    r_prime = filter_2(p, r);
    if (pvd) then do
      if (l == l_prime and r == r_prime) then do
        return m;
      end else do
        return join_2(l_prime, v, d, r_prime);
      end end 
    end else do
      return concat_2(l_prime, r_prime);
    end end 
  end else do
    return --[[ Empty ]]0;
  end end 
...
function partition_2(p, param) do
  if (param) then do
    d = param[--[[ d ]]3];
    v = param[--[[ v ]]2];
    match = partition_2(p, param[--[[ l ]]1]);
    lf = match[2];
    lt = match[1];
    pvd = Curry._2(p, v, d);
    match_1 = partition_2(p, param[--[[ r ]]4]);
    rf = match_1[2];
    rt = match_1[1];
    if (pvd) then do
      return --[[ tuple ]]{
      ...
      if (e2) then do
        ...
        if (c ~= 0) then do
          ...
          if (c_1 ~= 0) then do
            ...
            _e2 = cons_enum_2(e2[3], e2[4]);
            _e1 = cons_enum_2(e1[3], e1[4]);
            ::continue:: ;
          end end 
        end end 
      end else do
...
function cardinal_2(param) do
  if (param) then do
    return (cardinal_2(param[--[[ l ]]1]) + 1 | 0) + cardinal_2(param[--[[ r ]]4]) | 0;
  end else do
    return 0;
  end end 
end end
...
function app_meth(f, n) do
  return (function(obj) do
      return Curry._1(f, Curry._1(obj[1][n], obj));
    end end);
end end
...
function app_const_meth(f, x, n) do
  return (function(obj) do
      return Curry._2(f, x, Curry._1(obj[1][n], obj));
    end end);
end end
...
function app_meth_const(f, n, x) do
  return (function(obj) do
      return Curry._2(f, Curry._1(obj[1][n], obj), x);
    end end);
end end
...
function meth_app_const(n, x) do
  return (function(obj) do
      return Curry._2(obj[1][n], obj, x);
    end end);
end end

function meth_app_var(n, m) do
  return (function(obj) do
      return Curry._2(obj[1][n], obj, obj[m]);
    end end);
end end

function meth_app_env(n, e, m) do
  return (function(obj) do
      return Curry._2(obj[1][n], obj, obj[e][m]);
    end end);
end end

function meth_app_meth(n, m) do
  return (function(obj) do
      return Curry._2(obj[1][n], obj, Curry._1(obj[1][m], obj));
    end end);
end end
  ...
  if (type(clo) == "number") then do
    ...
    do
       ...
       if ___conditional___ == 2--[[ GetEnv ]] then do
          e = next(--[[ () ]]0);
          n_1 = next(--[[ () ]]0);
          return get_env(e, n_1); end end 
       if ___conditional___ == 3--[[ GetMeth ]] then do
          return get_meth(next(--[[ () ]]0)); end end 
       ...
       if ___conditional___ == 7--[[ AppEnv ]] then do
          ...
          e_1 = next(--[[ () ]]0);
          n_4 = next(--[[ () ]]0);
          return app_env(f_2, e_1, n_4); end end 
       if ___conditional___ == 8--[[ AppMeth ]] then do
          f_3 = next(--[[ () ]]0);
          n_5 = next(--[[ () ]]0);
          return app_meth(f_3, n_5); end end 
       ...
       if ___conditional___ == 10--[[ AppConstVar ]] then do
          ...
          x_3 = next(--[[ () ]]0);
          n_6 = next(--[[ () ]]0);
          return app_const_var(f_5, x_3, n_6); end end 
       if ___conditional___ == 11--[[ AppConstEnv ]] then do
          f_6 = next(--[[ () ]]0);
          x_4 = next(--[[ () ]]0);
          e_2 = next(--[[ () ]]0);
          n_7 = next(--[[ () ]]0);
          return app_const_env(f_6, x_4, e_2, n_7); end end 
       if ___conditional___ == 12--[[ AppConstMeth ]] then do
          f_7 = next(--[[ () ]]0);
          x_5 = next(--[[ () ]]0);
          n_8 = next(--[[ () ]]0);
          return app_const_meth(f_7, x_5, n_8); end end 
       if ___conditional___ == 13--[[ AppVarConst ]] then do
          f_8 = next(--[[ () ]]0);
          n_9 = next(--[[ () ]]0);
          x_6 = next(--[[ () ]]0);
          return app_var_const(f_8, n_9, x_6); end end 
       if ___conditional___ == 14--[[ AppEnvConst ]] then do
          f_9 = next(--[[ () ]]0);
          e_3 = next(--[[ () ]]0);
          n_10 = next(--[[ () ]]0);
          x_7 = next(--[[ () ]]0);
          return app_env_const(f_9, e_3, n_10, x_7); end end 
       if ___conditional___ == 15--[[ AppMethConst ]] then do
          f_10 = next(--[[ () ]]0);
          n_11 = next(--[[ () ]]0);
          x_8 = next(--[[ () ]]0);
          return app_meth_const(f_10, n_11, x_8); end end 
       if ___conditional___ == 16--[[ MethAppConst ]] then do
          n_12 = next(--[[ () ]]0);
          x_9 = next(--[[ () ]]0);
          return meth_app_const(n_12, x_9); end end 
       if ___conditional___ == 17--[[ MethAppVar ]] then do
          n_13 = next(--[[ () ]]0);
          m = next(--[[ () ]]0);
          return meth_app_var(n_13, m); end end 
       if ___conditional___ == 18--[[ MethAppEnv ]] then do
          n_14 = next(--[[ () ]]0);
          e_4 = next(--[[ () ]]0);
          m_1 = next(--[[ () ]]0);
          return meth_app_env(n_14, e_4, m_1); end end 
       if ___conditional___ == 19--[[ MethAppMeth ]] then do
          n_15 = next(--[[ () ]]0);
          m_2 = next(--[[ () ]]0);
          return meth_app_meth(n_15, m_2); end end 
       if ___conditional___ == 20--[[ SendConst ]] then do
          m_3 = next(--[[ () ]]0);
          x_10 = next(--[[ () ]]0);
          return send_const(m_3, x_10, new_cache(table)); end end 
       if ___conditional___ == 21--[[ SendVar ]] then do
          m_4 = next(--[[ () ]]0);
          n_16 = next(--[[ () ]]0);
          return send_var(m_4, n_16, new_cache(table)); end end 
       if ___conditional___ == 22--[[ SendEnv ]] then do
          m_5 = next(--[[ () ]]0);
          e_5 = next(--[[ () ]]0);
          n_17 = next(--[[ () ]]0);
          return send_env(m_5, e_5, n_17, new_cache(table)); end end 
       if ___conditional___ == 23--[[ SendMeth ]] then do
          m_6 = next(--[[ () ]]0);
          n_18 = next(--[[ () ]]0);
          return send_meth(m_6, n_18, new_cache(table)); end end 
