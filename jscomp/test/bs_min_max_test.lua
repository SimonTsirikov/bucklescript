...
eq("File \"bs_min_max_test.ml\", line 31, characters 5-12", Caml_obj.caml_min(nil, 3), nil);

eq("File \"bs_min_max_test.ml\", line 32, characters 5-12", Caml_obj.caml_min(3, nil), nil);

eq("File \"bs_min_max_test.ml\", line 33, characters 5-12", Caml_obj.caml_max(3, nil), 3);

eq("File \"bs_min_max_test.ml\", line 34, characters 5-12", Caml_obj.caml_max(nil, 3), 3);

b("File \"bs_min_max_test.ml\", line 35, characters 4-11", Caml_obj.caml_greaterequal(5, nil));

b("File \"bs_min_max_test.ml\", line 36, characters 4-11", Caml_obj.caml_lessequal(nil, 5));
