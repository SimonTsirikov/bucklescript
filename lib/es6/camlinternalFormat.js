...
function bprint_char_set(buf, char_set) do
  ...
  var print_out = function (set, _i) do
    while(true) do
      var i = _i;
      if (i < 256) do
        if (is_in_char_set(set, Pervasives.char_of_int(i))) do
          var set$1 = set;
          var i$1 = i;
          ...
          end else if (switcher > 47 or switcher < 1) do
  ...
  var print_second = function (set, i) do
    if (is_in_char_set(set, Pervasives.char_of_int(i))) do
      ...
      end else if ((switcher > 47 or switcher < 1) and !is_in_char_set(set, Pervasives.char_of_int(i + 1 | 0))) do
        print_char(buf, i - 1 | 0);
        return print_out(set, i + 1 | 0);
      end
      if (is_in_char_set(set, Pervasives.char_of_int(i + 1 | 0))) do
        var set$1 = set;
        var i$1 = i - 1 | 0;
        var _j = i + 2 | 0;
        while(true) do
          var j = _j;
          if (j == 256 or !is_in_char_set(set$1, Pervasives.char_of_int(j))) do
            print_char(buf, i$1);
            print_char(buf, --[ "-" ]--45);
...
function string_of_formatting_lit(formatting_lit) do
  if (typeof formatting_lit == "number") do
...
function trans(ty1, ty2) do
  var exit = 0;
  if (typeof ty1 == "number") do
    if (typeof ty2 == "number") do
      return --[ End_of_fmtty ]--0;
    end else do
      switch (ty2.tag | 0) do
        case --[ Format_arg_ty ]--8 :
    ...
    switch (ty1.tag | 0) do
      ...
      case --[ Alpha_ty ]--10 :
          ...
          end else if (ty2.tag == --[ Alpha_ty ]--10) do
    ...
    if (typeof fmtty == "number") do
      ...
      switch (fmtty.tag | 0) do
        ...
        case --[ Ignored_param ]--23 :
            ...
            var fmt = fmtty[1];
            if (typeof ign == "number") do
              if (ign == --[ Ignored_reader ]--2) do
                return --[ Ignored_reader_ty ]--Block.__(14, [fmtty_of_fmt(fmt)]);
              end else do
                return fmtty_of_fmt(fmt);
              end
            end else if (ign.tag == --[ Ignored_format_subst ]--9) do
...
function fmtty_of_padding_fmtty(pad, fmtty) do
  if (typeof pad == "number" or !pad.tag) do
    return fmtty;
  end else do
...
function fmtty_of_precision_fmtty(prec, fmtty) do
  if (typeof prec == "number" and prec ~= 0) do
    return --[ Int_ty ]--Block.__(2, [fmtty]);
  end else do
    return fmtty;
  end
...
function type_padding(pad, fmtty) do
  ...
  end else if (pad.tag) do
    if (typeof fmtty == "number") do
      throw Type_mismatch;
    end else if (fmtty.tag == --[ Int_ty ]--2) do
      return --[ Padding_fmtty_EBB ]--[
  ...
  if (typeof prec == "number") do
    if (prec ~= 0) do
      ...
      if (typeof match$1 == "number") do
        throw Type_mismatch;
      end else if (match$1.tag == --[ Int_ty ]--2) do
  ...
  if (typeof sub_fmtty == "number") do
    ...
    switch (sub_fmtty.tag | 0) do
      ...
      case --[ String_ty ]--1 :
          if (typeof fmtty == "number") do
            throw Type_mismatch;
          end else if (fmtty.tag == --[ String_ty ]--1) do
      ...
      case --[ Int32_ty ]--3 :
          if (typeof fmtty == "number") do
            throw Type_mismatch;
          end else if (fmtty.tag == --[ Int32_ty ]--3) do
      ...
      case --[ Nativeint_ty ]--4 :
          if (typeof fmtty == "number") do
            throw Type_mismatch;
          end else if (fmtty.tag == --[ Nativeint_ty ]--4) do
      ...
      case --[ Int64_ty ]--5 :
          if (typeof fmtty == "number") do
            throw Type_mismatch;
          end else if (fmtty.tag == --[ Int64_ty ]--5) do
      ...
      case --[ Float_ty ]--6 :
          if (typeof fmtty == "number") do
            throw Type_mismatch;
          end else if (fmtty.tag == --[ Float_ty ]--6) do
      ...
      case --[ Bool_ty ]--7 :
          if (typeof fmtty == "number") do
            throw Type_mismatch;
          end else if (fmtty.tag == --[ Bool_ty ]--7) do
      ...
      case --[ Format_arg_ty ]--8 :
          if (typeof fmtty == "number") do
            throw Type_mismatch;
          end else if (fmtty.tag == --[ Format_arg_ty ]--8) do
            var sub2_fmtty$prime = fmtty[0];
            if (Caml_obj.caml_notequal(--[ Fmtty_EBB ]--[sub_fmtty[0]], --[ Fmtty_EBB ]--[sub2_fmtty$prime])) do
              throw Type_mismatch;
            end
      ...
      case --[ Format_subst_ty ]--9 :
          if (typeof fmtty == "number") do
            throw Type_mismatch;
          end else if (fmtty.tag == --[ Format_subst_ty ]--9) do
            var sub2_fmtty$prime$1 = fmtty[1];
            var sub1_fmtty$prime = fmtty[0];
            if (Caml_obj.caml_notequal(--[ Fmtty_EBB ]--[CamlinternalFormatBasics.erase_rel(sub_fmtty[0])], --[ Fmtty_EBB ]--[CamlinternalFormatBasics.erase_rel(sub1_fmtty$prime)])) do
              throw Type_mismatch;
            end
            if (Caml_obj.caml_notequal(--[ Fmtty_EBB ]--[CamlinternalFormatBasics.erase_rel(sub_fmtty[1])], --[ Fmtty_EBB ]--[CamlinternalFormatBasics.erase_rel(sub2_fmtty$prime$1)])) do
              throw Type_mismatch;
            end
      ...
      case --[ Alpha_ty ]--10 :
          if (typeof fmtty == "number") do
            throw Type_mismatch;
          end else if (fmtty.tag == --[ Alpha_ty ]--10) do
      ...
      case --[ Theta_ty ]--11 :
          if (typeof fmtty == "number") do
            throw Type_mismatch;
          end else if (fmtty.tag == --[ Theta_ty ]--11) do
      ...
      case --[ Reader_ty ]--13 :
          if (typeof fmtty == "number") do
            throw Type_mismatch;
          end else if (fmtty.tag == --[ Reader_ty ]--13) do
      ...
      case --[ Ignored_reader_ty ]--14 :
          if (typeof fmtty == "number") do
            throw Type_mismatch;
          end else if (fmtty.tag == --[ Ignored_reader_ty ]--14) do
    ...
    switch (fmt.tag | 0) do
      ...
      case --[ String ]--2 :
          ...
          if (typeof match$3 == "number") do
            throw Type_mismatch;
          end else if (match$3.tag == --[ String_ty ]--1) do
      ...
      case --[ Caml_string ]--3 :
          ...
          if (typeof match$6 == "number") do
            throw Type_mismatch;
          end else if (match$6.tag == --[ String_ty ]--1) do
      ...
      case --[ Int ]--4 :
          ...
          if (typeof match$9 == "number") do
            throw Type_mismatch;
          end else if (match$9.tag == --[ Int_ty ]--2) do
      ...
      case --[ Int32 ]--5 :
          ...
          if (typeof match$12 == "number") do
            throw Type_mismatch;
          end else if (match$12.tag == --[ Int32_ty ]--3) do
      ...
      case --[ Nativeint ]--6 :
          ...
          if (typeof match$15 == "number") do
            throw Type_mismatch;
          end else if (match$15.tag == --[ Nativeint_ty ]--4) do
      ...
      case --[ Int64 ]--7 :
          ...
          if (typeof match$18 == "number") do
            throw Type_mismatch;
          end else if (match$18.tag == --[ Int64_ty ]--5) do
      ...
      case --[ Float ]--8 :
          ...
          if (typeof match$21 == "number") do
            throw Type_mismatch;
          end else if (match$21.tag == --[ Float_ty ]--6) do
      ...
      case --[ Bool ]--9 :
          ...
          if (typeof match$24 == "number") do
            throw Type_mismatch;
          end else if (match$24.tag == --[ Bool_ty ]--7) do
      ...
      case --[ Format_arg ]--13 :
          if (typeof fmtty == "number") do
            ...
            if (Caml_obj.caml_notequal(--[ Fmtty_EBB ]--[fmt[1]], --[ Fmtty_EBB ]--[sub_fmtty$prime])) do
              throw Type_mismatch;
            end
      ...
      case --[ Format_subst ]--14 :
          if (typeof fmtty == "number") do
            ...
            if (Caml_obj.caml_notequal(--[ Fmtty_EBB ]--[CamlinternalFormatBasics.erase_rel(fmt[1])], --[ Fmtty_EBB ]--[CamlinternalFormatBasics.erase_rel(sub_fmtty1)])) do
              throw Type_mismatch;
            end
      ...
      case --[ Ignored_param ]--23 :
          ...
          if (typeof ign == "number") do
            if (ign == --[ Ignored_reader ]--2) do
              if (typeof fmtty$1 == "number") do
                throw Type_mismatch;
              end else if (fmtty$1.tag == --[ Ignored_reader_ty ]--14) do
  ...
  if (width$1 <= len) do
    ...
    switch (padty$1) do
      ...
      case --[ Right ]--1 :
          ...
          break;
      case --[ Zeros ]--2 :
          if (len > 0 and (Caml_string.get(str, 0) == --[ "+" ]--43 or Caml_string.get(str, 0) == --[ "-" ]--45 or Caml_string.get(str, 0) == --[ " " ]--32)) do
            res[0] = Caml_string.get(str, 0);
            $$String.blit(str, 1, res, (width$1 - len | 0) + 1 | 0, len - 1 | 0);
          end else if (len > 1 and Caml_string.get(str, 0) == --[ "0" ]--48 and (Caml_string.get(str, 1) == --[ "x" ]--120 or Caml_string.get(str, 1) == --[ "X" ]--88)) do
    ...
    if (c >= 43) do
      switch (c - 43 | 0) do
        ...
        case 4 :
            return str;
        case 5 :
            if ((prec$1 + 2 | 0) > len and len > 1 and (Caml_string.get(str, 1) == --[ "x" ]--120 or Caml_string.get(str, 1) == --[ "X" ]--88)) do
  ...
  if (fconv >= 16) do
    ...
    if (fconv ~= --[ Float_F ]--15) do
      ...
      var is_valid = function (_i) do
        while(true) do
          ...
          if (i == len) do
            ...
            end else if (switcher > 22 or switcher < 1) do
              return true;
            end else do
              _i = i + 1 | 0;
              continue ;
      ...
      if (match ~= 3) do
        if (match >= 4) do
          return "nan";
        end else if (is_valid(0)) do
          return str$1;
        end else do
          return str$1 .. ".";
        end
      end else if (x < 0.0) do
        return "neg_infinity";
      end else do
        return "infinity";
      end
  ...
  while(true) do
    ...
    if (typeof fmt == "number") do
      ...
      switch (fmt.tag | 0) do
        case --[ String ]--2 :
            var tmp = fmt[0];
            if (typeof tmp ~= "number" and tmp.tag) do
        ...
        case --[ Caml_string ]--3 :
            var tmp$1 = fmt[0];
            if (typeof tmp$1 ~= "number" and tmp$1.tag) do
        ...
        case --[ Bool ]--9 :
            var tmp$2 = fmt[0];
            if (typeof tmp$2 ~= "number" and tmp$2.tag) do
        ...
        default:
          ...
          end else if (typeof prec == "number") do
            if (prec ~= 0) do
...
function fmt_ebb_of_string(legacy_behavior, str) do
      ...
      if (c >= 65) do
        ...
        if (c >= 32) do
          switch (c - 32 | 0) do
            ...
            case 5 :
                if ((str_ind + 1 | 0) < end_ind and Caml_string.get(str, str_ind + 1 | 0) == --[ "%" ]--37) do
            ...
            case 27 :
                ...
                var match$7;
                try do
                  if (str_ind$1 == end_ind$1 or Caml_string.get(str, str_ind$1) ~= --[ "<" ]--60) do
                  ...
                  if (exit == 1) do
                    ...
                    if (switcher > 12 or switcher < 0) do
                      if (switcher ~= 17) do
                        throw Caml_builtin_exceptions.not_found;
                      end
                  ...
                  var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
                  if (exn == Caml_builtin_exceptions.not_found or exn[0] == Caml_builtin_exceptions.failure) do
                    match$7 = --[ tuple ]--[
                      str_ind$1,
                      --[ Break ]--Block.__(0, [
                          "@;",
            ...
            case 28 :
                ...
                try do
                  ...
                  if (exit$1 == 1) do
                    ...
                    if (Caml_string.get(str, str_ind_3$1) ~= --[ ">" ]--62) do
                      throw Caml_builtin_exceptions.not_found;
                    end
                  ...
                  if (exn$1 == Caml_builtin_exceptions.not_found or exn$1[0] == Caml_builtin_exceptions.failure) do
                    match$13 = undefined;
                  end else do
                    throw exn$1;
                  end
  ...
  var parse_spaces = function (_str_ind, end_ind) do
    while(true) do
      ...
      if (Caml_string.get(str, str_ind) == --[ " " ]--32) do
        _str_ind = str_ind + 1 | 0;
        continue ;
      end else do
        return str_ind;
  ...
  var parse_flags = function (pct_ind, str_ind, end_ind, ign) do
    ...
    var set_flag = function (str_ind, flag) do
      if (flag.contents and !legacy_behavior$1) do
  ...
  var search_subformat_end = function (_str_ind, end_ind, c) do
    while(true) do
      ...
      if (match ~= 37) do
        ...
        if ((str_ind + 1 | 0) == end_ind) do
          invalid_format_message(end_ind, "unexpected end of format");
        end
        if (Caml_string.get(str, str_ind + 1 | 0) == c) do
          return str_ind;
        end else do
          ...
          if (match$1 >= 95) do
            ...
            end else if (match$1 < 96) do
              if ((str_ind + 2 | 0) == end_ind) do
                invalid_format_message(end_ind, "unexpected end of format");
              end
  ...
  var check_open_box = function (fmt) do
    if (typeof fmt == "number" or !(fmt.tag == --[ String_literal ]--11 and typeof fmt[1] == "number")) do
      return --[ () ]--0;
    end else do
      try do
  ...
  var parse_conversion = function (pct_ind, str_ind, end_ind, plus, hash, space, ign, pad, prec, padprec, symb) do
    ...
    if (symb >= 124) do
      ...
      switch (symb) do
        ...
        case 40 :
            ...
            if (ign_used.contents = true, ign) do
    ...
    switch (exit$2) do
      case 7 :
          ...
          break;
      case 8 :
          if (str_ind == end_ind or !is_int_base(Caml_string.get(str, str_ind))) do
    ...
    if (!legacy_behavior$1) do
      if (!plus_used and plus) do
        incompatible_flag(pct_ind, str_ind, symb, "'+'");
      end
      if (!hash_used and hash) do
        incompatible_flag(pct_ind, str_ind, symb, "'#'");
      end
      if (!space_used and space) do
        incompatible_flag(pct_ind, str_ind, symb, "' '");
      end
      if (!pad_used.contents and Caml_obj.caml_notequal(--[ Padding_EBB ]--[pad], --[ Padding_EBB ]--[--[ No_padding ]--0])) do
        incompatible_flag(pct_ind, str_ind, symb, "`padding'");
      end
      if (!prec_used.contents and Caml_obj.caml_notequal(--[ Precision_EBB ]--[prec], --[ Precision_EBB ]--[--[ No_precision ]--0])) do
    ...
    if (!ign_used.contents and ign) do
      var exit$3 = 0;
      if (symb >= 38) do
        if (symb ~= 44) do
          if (symb ~= 64 or !legacy_behavior$1) do
            exit$3 = 1;
          end
          
        end else if (!legacy_behavior$1) do
          exit$3 = 1;
        end
        
      end else if (symb ~= 33) do
        if (!(symb >= 37 and legacy_behavior$1)) do
          exit$3 = 1;
        end
  ...
  var parse_after_padding = function (pct_ind, str_ind, end_ind, minus, plus, hash, space, ign, pad) do
    ...
    if (symb ~= 46) do
      ...
      if (exit == 2 and legacy_behavior$1) do
        ...
        if (c$prime >= 46) do
          ...
          if (c$prime >= 45) do
            ...
            if (c$prime$1 ~= 37) do
              ...
              if ((str_ind$1 + 1 | 0) == end_ind$1) do
                invalid_format_message(end_ind$1, "unexpected end of format");
              end
              var c$prime$2 = Caml_string.get(str, str_ind$1 + 1 | 0);
              if (c$prime$2 ~= 37 and c$prime$2 ~= 64) do
