  ...
  if (match ~= undefined) {
    ...
    if (isid(c)) {
      ...
      while(true) {
        ...
        if (param$1) {
          var lop = param$1[0];
          if (Caml_string.get(lop, 0) == ch$2 and Caml_string.get(lop, 1) == peekch(--[ () ]--0)) {
            Curry._1(getch, --[ () ]--0);
...
function stmt(brk, stk) {
  ...
  } else if (Caml_obj.caml_equal(t, tokwhile) or Caml_obj.caml_equal(t, tokfor)) {
    var bl = {
      contents: 0
    };
