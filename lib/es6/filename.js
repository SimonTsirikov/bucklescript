...
function is_implicit(n) {
  if (is_relative(n) and (#n < 2 or $$String.sub(n, 0, 2) ~= "./")) {
    if (#n < 3) {
      return true;
    } else {
...
function is_relative$1(n) {
  if ((#n < 1 or Caml_string.get(n, 0) ~= --[ "/" ]--47) and (#n < 1 or Caml_string.get(n, 0) ~= --[ "\\" ]--92)) {
    if (#n < 2) {
      return true;
    } else {
...
function is_implicit$1(n) {
  if (is_relative$1(n) and (#n < 2 or $$String.sub(n, 0, 2) ~= "./") and (#n < 2 or $$String.sub(n, 0, 2) ~= ".\\") and (#n < 3 or $$String.sub(n, 0, 3) ~= "../")) {
    if (#n < 3) {
      return true;
    } else {
      return $$String.sub(n, 0, 3) ~= "..\\";
...
function has_drive(s) {
  ...
  if (#s >= 2 and is_letter(Caml_string.get(s, 0))) {
