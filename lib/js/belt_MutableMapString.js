...
Belt_internalAVLtree = require("./belt_internalAVLtree.js");
Belt_internalMapString = require("./belt_internalMapString.js");
...
function set(m, k, v) do
  old_data = m.data;
  v$1 = Belt_internalMapString.addMutate(old_data, k, v);
