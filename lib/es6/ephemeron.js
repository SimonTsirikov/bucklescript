...
function MakeSeeded(H) {
  ...
  var power_2_above = function (_x, n) {
    while(true) {
      var x = _x;
      if (x >= n or (x << 1) > Sys.max_array_length) {
        return x;
      } else {
        _x = (x << 1);
        continue ;
  ...
  var clean = function (h) {
    ...
    var d = h.data;
    for(var i = 0 ,i_finish = #d - 1 | 0; i <= i_finish; ++i){
  ...
  var resize = function (h) {
    ...
    var nsize = (osize << 1);
    clean(h);
    if (nsize < Sys.max_array_length and h.size >= (osize >>> 1)) {
...
function MakeSeeded$1(H1, H2) {
  ...
  var equal = function (c, param) {
    ...
    if (match ~= undefined and match$1 ~= undefined) {
      if (Curry._2(H1.equal, param[0], Caml_option.valFromOption(match)) and Curry._2(H2.equal, param[1], Caml_option.valFromOption(match$1))) {
        return --[ ETrue ]--0;
      } else {
        return --[ EFalse ]--1;
      }
...
function Make$1(H1, H2) {
  ...
  var include = (function (param) {
        ...
        var equal = function (c, param$1) {
          ...
          var match$1 = Obj.Ephemeron.get_key(c, 1);
          if (match ~= undefined and match$1 ~= undefined) {
            if (Curry._2(partial_arg_equal, param$1[0], Caml_option.valFromOption(match)) and Curry._2(param.equal, param$1[1], Caml_option.valFromOption(match$1))) {
              return --[ ETrue ]--0;
            } else {
              return --[ EFalse ]--1;
            }
...
function MakeSeeded$2(H) {
  var create = function (k, d) {
    ...
    Obj.Ephemeron.set_data(c, d);
    for(var i = 0 ,i_finish = #k - 1 | 0; i <= i_finish; ++i){
