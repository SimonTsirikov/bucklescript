...
function is_zero(param) {
  if (param[--[ hi ]--0] ~= 0 or param[--[ lo ]--1] ~= 0) {
    return false;
  } else {
    return true;
  }
...
function mul(_this, _other) {
  while(true) {
    ...
    var exit = 0;
    var exit$1 = 0;
    if ($$this[--[ hi ]--0] ~= 0 or $$this[--[ lo ]--1] ~= 0) {
      exit$1 = 3;
    } else {
      return zero;
    }
    if (exit$1 == 3) {
      if (other[--[ hi ]--0] ~= 0 or other[--[ lo ]--1] ~= 0) {
        exit = 2;
      } else {
        return zero;
      }
    ...
    if (exit == 2) {
      ...
      var exit$2 = 0;
      if (this_hi ~= -2147483648 or $$this[--[ lo ]--1] ~= 0) {
        exit$2 = 3;
      } else {
        lo = other[--[ lo ]--1];
      }
      if (exit$2 == 3) {
        ...
        var lo$1 = $$this[--[ lo ]--1];
        var exit$3 = 0;
        if (other_hi ~= -2147483648 or other[--[ lo ]--1] ~= 0) {
          exit$3 = 4;
        } else {
          lo = lo$1;
        }
  ...
  while(true) {
    ...
    if (exit$1 == 3) {
      ...
      if (match ~= -2147483648) {
        ...
        exit = 2;
      } else if (eq(other, one) or eq(other, neg_one)) {
        return self;
        ...
        var exit$2 = 0;
        if (approx[--[ hi ]--0] ~= 0 or approx[--[ lo ]--1] ~= 0) {
          exit$2 = 4;
    ...
    if (exit == 2 and other[--[ hi ]--0] == -2147483648 and other[--[ lo ]--1] == 0) {
      return zero;
    }
    var other_hi = other[--[ hi ]--0];
    if (self[--[ hi ]--0] < 0) {
      ...
      while(ge(rem$1, other)) {
        ...
        while(approxRem[--[ hi ]--0] < 0 or gt(approxRem, rem$1)) {
