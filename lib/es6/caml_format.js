      ...
      if (k == len) {
        ...
        if (a == --[ "_" ]--95) {
          ...
          if (Caml_int64.lt(v, --[ int64 ]--[
                  --[ hi ]--0,
                  --[ lo ]--0
                ]) or Caml_int64.ge(v, base) or Caml_int64.gt(acc, threshold)) {
            throw [
                  Caml_builtin_exceptions.failure,
                  "int64_of_string"
                ];
...
function finish_formatting(config, rawbuffer) {
  ...
  if (signedconv and (sign < 0 or signstyle ~= "-")) {
    len = len + 1 | 0;
  }
  if (alternate) {
    if (base == --[ Oct ]--0) {
  ...
  if (alternate and base == --[ Oct ]--0) {
    buffer = buffer .. "0";
  }
  if (alternate and base == --[ Hex ]--1) {
    buffer = buffer .. "0x";
  }
  if (justify == "+" and filter == "0") {
  ...
  if (isNaN(x$1)) {
    ...
    switch (match) {
      ...
      case "g" :
          ...
          if (exp < -4 or x$1 >= 1e21 or x$1.toFixed().length > prec$1) {
            var i$1 = j - 1 | 0;
            while(s[i$1] == "0") {
              i$1 = i$1 - 1 | 0;
            };
