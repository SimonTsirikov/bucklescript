...
function reset(h) do
  var len = #h.data;
  if (len == Pervasives.abs(h.initial_size)) do
    return clear(h);
  end else do
    h.size = 0;
...
function remove(h, key) do
  ...
  while(true) do
    ...
    if (c) do
      var k = c[--[ key ]--0];
      var next = c[--[ next ]--2];
      if (Caml_obj.caml_equal(k, key$1)) do
...
function find(h, key) do
  ...
  if (match) do
    ...
    if (Caml_obj.caml_equal(key, k1)) do
      return d1;
    end else if (next1) do
      var k2 = next1[--[ key ]--0];
      var d2 = next1[--[ data ]--1];
      var next2 = next1[--[ next ]--2];
      if (Caml_obj.caml_equal(key, k2)) do
        return d2;
      end else if (next2) do
        var k3 = next2[--[ key ]--0];
        var d3 = next2[--[ data ]--1];
        var next3 = next2[--[ next ]--2];
        if (Caml_obj.caml_equal(key, k3)) do
          return d3;
        end else do
          var key$1 = key;
          var _param = next3;
          while(true) do
            ...
            if (param) do
              ...
              var data = param[--[ data ]--1];
              var next = param[--[ next ]--2];
              if (Caml_obj.caml_equal(key$1, k)) do
                return data;
              end else do
                _param = next;
                continue ;
  ...
  var find_in_bucket = function (_param) do
    while(true) do
      ...
      if (param) do
        ...
        var data = param[--[ data ]--1];
        var next = param[--[ next ]--2];
        if (Caml_obj.caml_equal(k, key)) do
          return --[ :: ]--[
                  data,
                  find_in_bucket(next)
                ];
...
function replace(h, key, data) do
  ...
  if (replace_bucket(key, data, l)) do
...
function MakeSeeded(H) do
  ...
  var remove = function (h, key) do
    ...
    while(true) do
      ...
      if (c) do
        var k = c[--[ key ]--0];
        var next = c[--[ next ]--2];
        if (Curry._2(H.equal, k, key$1)) do
          h$1.size = h$1.size - 1 | 0;
          if (prec) do
            prec[--[ next ]--2] = next;
            return --[ () ]--0;
  ...
  var find = function (h, key) do
    ...
    if (match) do
      ...
      var d1 = match[--[ data ]--1];
      var next1 = match[--[ next ]--2];
      if (Curry._2(H.equal, key, k1)) do
        return d1;
      end else if (next1) do
        var k2 = next1[--[ key ]--0];
        var d2 = next1[--[ data ]--1];
        var next2 = next1[--[ next ]--2];
        if (Curry._2(H.equal, key, k2)) do
          return d2;
        end else if (next2) do
          var k3 = next2[--[ key ]--0];
          var d3 = next2[--[ data ]--1];
          var next3 = next2[--[ next ]--2];
          if (Curry._2(H.equal, key, k3)) do
            return d3;
          end else do
            var key$1 = key;
            var _param = next3;
            while(true) do
              ...
              if (param) do
                ...
                var data = param[--[ data ]--1];
                var next = param[--[ next ]--2];
                if (Curry._2(H.equal, key$1, k)) do
                  return data;
                end else do
                  _param = next;
                  continue ;
...
function Make(H) do
  ...
  var find = function (h, key) do
    ...
    if (match) do
      ...
      var d1 = match[--[ data ]--1];
      var next1 = match[--[ next ]--2];
      if (Curry._2(equal, key, k1)) do
        return d1;
      end else if (next1) do
        var k2 = next1[--[ key ]--0];
        var d2 = next1[--[ data ]--1];
        var next2 = next1[--[ next ]--2];
        if (Curry._2(equal, key, k2)) do
          return d2;
        end else if (next2) do
          var k3 = next2[--[ key ]--0];
          var d3 = next2[--[ data ]--1];
          var next3 = next2[--[ next ]--2];
          if (Curry._2(equal, key, k3)) do
            return d3;
          end else do
            var key$1 = key;
            var _param = next3;
