...
function from_function(f) {
  ...
  return {
          refill_buff: (function (param) {
              ...
              if ((lexbuf.lex_buffer_len + n | 0) > #lexbuf.lex_buffer) {
                if (((lexbuf.lex_buffer_len - lexbuf.lex_start_pos | 0) + n | 0) <= #lexbuf.lex_buffer) {
                ...
                for(var i = 0 ,i_finish = #t - 1 | 0; i <= i_finish; ++i){
