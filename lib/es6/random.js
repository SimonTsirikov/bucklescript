...
function $$int(s, bound) do
  if (bound > 1073741823 or bound <= 0) do
    throw [
  ...
  while(true) do
    var r = bits(s$1);
    var v = r % n;
    if ((r - v | 0) > ((1073741823 - n | 0) + 1 | 0)) do
      continue ;
    end else do
      return v;
    end
...
function int32(s, bound) do
  ...
  while(true) do
    ...
    var r = b1 | b2;
    var v = r % n;
    if ((r - v | 0) > ((Int32.max_int - n | 0) + 1 | 0)) do
      continue ;
    end else do
      return v;
    end
...
var nativeint = Nativeint.size == 32 ? int32 : (function (s, bound) do
