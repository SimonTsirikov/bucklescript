...
function for_all(p, _param) {
  while(true) {
    var param = _param;
    if (param) {
      if (Curry._2(p, param[--[ v ]--1], param[--[ d ]--2]) and for_all(p, param[--[ l ]--0])) {
        _param = param[--[ r ]--3];
        continue ;
      } else {
        return false;
...
function exists(p, _param) {
  while(true) {
    var param = _param;
    if (param) {
      if (Curry._2(p, param[--[ v ]--1], param[--[ d ]--2]) or exists(p, param[--[ l ]--0])) {
        return true;
      } else {
        _param = param[--[ r ]--3];
        continue ;
...
function equal(cmp, m1, m2) {
  ...
  while(true) {
    ...
    var e1 = _e1;
    if (e1) {
      if (e2 and Caml_primitive.caml_string_compare(e1[0], e2[0]) == 0 and Curry._2(cmp, e1[1], e2[1])) {
        _e2 = cons_enum(e2[2], e2[3]);
        _e1 = cons_enum(e1[2], e1[3]);
        continue ;
      } else {
...
function for_all$1(p, _param) {
  while(true) {
    var param = _param;
    if (param) {
      if (Curry._2(p, param[--[ v ]--1], param[--[ d ]--2]) and for_all$1(p, param[--[ l ]--0])) {
        _param = param[--[ r ]--3];
        continue ;
      } else {
        return false;
...
function exists$1(p, _param) {
  while(true) {
    var param = _param;
    if (param) {
      if (Curry._2(p, param[--[ v ]--1], param[--[ d ]--2]) or exists$1(p, param[--[ l ]--0])) {
        return true;
      } else {
        _param = param[--[ r ]--3];
        continue ;
...
function for_all$2(p, _param) {
  while(true) {
    var param = _param;
    if (param) {
      if (Curry._2(p, param[--[ v ]--1], param[--[ d ]--2]) and for_all$2(p, param[--[ l ]--0])) {
        _param = param[--[ r ]--3];
        continue ;
      } else {
        return false;
...
function exists$2(p, _param) {
  while(true) {
    var param = _param;
    if (param) {
      if (Curry._2(p, param[--[ v ]--1], param[--[ d ]--2]) or exists$2(p, param[--[ l ]--0])) {
        return true;
      } else {
        _param = param[--[ r ]--3];
        continue ;
...
function equal$2(cmp, m1, m2) {
  ...
  while(true) {
    ...
    var e1 = _e1;
    if (e1) {
      if (e2 and e1[0] == e2[0] and Curry._2(cmp, e1[1], e2[1])) {
        _e2 = cons_enum$2(e2[2], e2[3]);
        _e1 = cons_enum$2(e1[2], e1[3]);
        continue ;
      } else {
...
function new_cache(table) {
  ...
  var n$1 = n % 2 == 0 or n > (2 + Caml_int32.div((Caml_array.caml_array_get(table.methods, 1) << 4), Sys.word_size) | 0) ? n : new_method(table);
