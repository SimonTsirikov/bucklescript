...
function g(a, b, c, d, x, s, t) do
  return cmn(b & d | c & (d ^ -1), a, b, x, s, t);
end

function h(a, b, c, d, x, s, t) do
  return cmn(b ^ c ^ d, a, b, x, s, t);
end

function i(a, b, c, d, x, s, t) do
  return cmn(c ^ (b | d ^ -1), a, b, x, s, t);
end

function cycle(x, k) do
  var a = x[0];
  var b = x[1];
  var c = x[2];
  var d = x[3];
...
function caml_md5_string(s, start, len) do
  ...
  var i_end = n / 64 | 0;
  for(var i$1 = 1; i$1 <= i_end; ++i$1)do
    for(var j = 0; j <= 15; ++j)do
  ...
  for(var kk = 0; kk <= 15; ++kk)do
    md5blk[kk] = 0;
  end
  var i_end$1 = #s_tail - 1 | 0;
  for(var i$2 = 0; i$2 <= i_end$1; ++i$2)do
