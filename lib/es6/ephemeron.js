...
function MakeSeeded(H) do
  ...
  var equal = function (c, k) do
    ...
    if (match ~= undefined) do
      if (Curry._2(H.equal, k, Caml_option.valFromOption(match))) do
        return --[ ETrue ]--0;
      end else do
        return --[ EFalse ]--1;
      end
  ...
  var power_2_above = function (_x, n) do
    while(true) do
      var x = _x;
      if (x >= n or (x << 1) > Sys.max_array_length) do
        return x;
      end else do
        _x = (x << 1);
        continue ;
  ...
  var create$1 = function (randomOpt, initial_size) do
    var random = randomOpt ~= undefined ? randomOpt : Hashtbl.is_randomized(--[ () ]--0);
  ...
  var resize = function (h) do
    ...
    var nsize = (osize << 1);
    clean(h);
    if (nsize < Sys.max_array_length and h.size >= (osize >>> 1)) do
    ...
    var do_bucket = function (_b, _accu) do
      while(true) do
        ...
        if (b) do
          ...
          var match = get_key(c);
          var match$1 = get_data(c);
          var accu$1 = match ~= undefined and match$1 ~= undefined ? Curry._3(f, Caml_option.valFromOption(match), Caml_option.valFromOption(match$1), accu) : accu;
          _accu = accu$1;
          _b = b[2];
          continue ;
        end else do
...
function Make(H) do
  ...
  var equal$1 = function (c, k) do
    var match = Obj.Ephemeron.get_key(c, 0);
    if (match ~= undefined) do
      if (Curry._2(equal, k, Caml_option.valFromOption(match))) do
        return --[ ETrue ]--0;
      end else do
        return --[ EFalse ]--1;
      end
...
function MakeSeeded$1(H1, H2) do
  ...
  var equal = function (c, param) do
    ...
    if (match ~= undefined and match$1 ~= undefined) do
      if (Curry._2(H1.equal, param[0], Caml_option.valFromOption(match)) and Curry._2(H2.equal, param[1], Caml_option.valFromOption(match$1))) do
        return --[ ETrue ]--0;
      end else do
        return --[ EFalse ]--1;
      end
  ...
  var check_key = function (c) do
    if (Obj.Ephemeron.check_key(c, 0)) do
...
function Make$1(H1, H2) do
  ...
  var include = (function (param) do
        ...
        var equal = function (c, param$1) do
          ...
          var match$1 = Obj.Ephemeron.get_key(c, 1);
          if (match ~= undefined and match$1 ~= undefined) do
            if (Curry._2(partial_arg_equal, param$1[0], Caml_option.valFromOption(match)) and Curry._2(param.equal, param$1[1], Caml_option.valFromOption(match$1))) do
              return --[ ETrue ]--0;
            end else do
              return --[ EFalse ]--1;
            end
        ...
        var bucket_length_alive = function (_accu, _param) do
          while(true) do
            ...
            if (param) do
              var rest = param[2];
              if (Curry._1(check_key, param[1])) do
                _param = rest;
                _accu = accu + 1 | 0;
                continue ;
              end else do
...
function MakeSeeded$2(H) do
  var create = function (k, d) do
    ...
    Obj.Ephemeron.set_data(c, d);
    for(var i = 0 ,i_finish = #k - 1 | 0; i <= i_finish; ++i)do
    ...
    if (len ~= len$prime) do
      ...
      while(true) do
        ...
        if (i < 0) do
          ...
          if (match ~= undefined) do
            if (Curry._2(H.equal, Caml_array.caml_array_get(k$1, i), Caml_option.valFromOption(match))) do
              _i = i - 1 | 0;
              continue ;
            end else do
              return --[ EFalse ]--1;
  ...
  var check_key = function (c) do
    ...
    while(true) do
      ...
      if (i < 0) do
        return true;
      end else if (Obj.Ephemeron.check_key(c$1, i)) do
        _i = i - 1 | 0;
        continue ;
      end else do
        return false;
    ...
    if (len ~= len$prime) do
      ...
      while(true) do
        ...
        if (i < 0) do
          ...
          var match = Obj.Ephemeron.get_key(c$1, i);
          if (match ~= undefined) do
            if (Curry._2(equal, Caml_array.caml_array_get(k$1, i), Caml_option.valFromOption(match))) do
              _i = i - 1 | 0;
              continue ;
            end else do
              return --[ EFalse ]--1;
  ...
  MakeSeeded: (function (funarg) do
      ...
      var bucket_length_alive = function (_accu, _param) do
        while(true) do
          ...
          if (param) do
            var rest = param[2];
            if (Curry._1(H.check_key, param[1])) do
              _param = rest;
              _accu = accu + 1 | 0;
              continue ;
            end else do
