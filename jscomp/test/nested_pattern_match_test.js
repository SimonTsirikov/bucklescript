...
function f_opion(x) {
  ...
  if (match ~= 2) {
    if (match ~= 3) {
      ...
      var match$1 = x.lo;
      if (match$1 and match$1[0] == undefined) {
        var match$2 = match$1[1];
        if (match$2 and match$2[0] == undefined) {
          var match$3 = match$2[1];
          if (match$3) {
            ...
            if (match$4 == 2) {
              ...
              if (match$5) {
                ...
                if (match$6 == 1) {
                  ...
                  if (match$7 and match$7[0] ~= undefined) {
                    return 2;
                  } else {
                    return 0;
                  }
    ...
    var match$8 = x.lo;
    if (match$8 and match$8[0] == undefined) {
      var match$9 = match$8[1];
      if (match$9 and match$9[0] == undefined) {
          ...
          if (match$11 == 2) {
            ...
            if (match$12) {
              ...
              if (match$13 == 1) {
                ...
                if (match$14 and match$14[0] ~= undefined) {
                  return 3;
                } else {
                  return 0;
                }
