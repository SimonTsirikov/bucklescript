...
function everyU(_n, p) do
  while(true) do
    var n = _n;
    if (n ~= null) do
      if (p(n.value) and everyU(n.left, p)) do
        _n = n.right;
        continue ;
      end else do
        return false;
...
function someU(_n, p) do
  while(true) do
    var n = _n;
    if (n ~= null) do
      if (p(n.value) or someU(n.left, p)) do
        return true;
      end else do
        _n = n.right;
        continue ;
    ...
    if (s1 ~= null) do
      if (s2 ~= null) do
        ...
        if (c == 0) do
          ...
          if (subset(create(l1, v1, null), l2, cmp)) do
            _s1 = r1;
            continue ;
          end else do
            return false;
          end
        end else if (subset(create(null, v1, r1), r2, cmp)) do
          _s1 = l1;
          continue ;
        end else do
          return false;
