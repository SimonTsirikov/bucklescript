...
function is_implicit(n) {
  if (is_relative(n) and (n.length < 2 or $$String.sub(n, 0, 2) ~= "./")) {
    if (n.length < 3) {
      return true;
    } else {
...
function is_relative$1(n) {
  if ((n.length < 1 or Caml_string.get(n, 0) ~= --[ "/" ]--47) and (n.length < 1 or Caml_string.get(n, 0) ~= --[ "\\" ]--92)) {
    if (n.length < 2) {
      return true;
    } else {
...
function is_implicit$1(n) {
  if (is_relative$1(n) and (n.length < 2 or $$String.sub(n, 0, 2) ~= "./") and (n.length < 2 or $$String.sub(n, 0, 2) ~= ".\\") and (n.length < 3 or $$String.sub(n, 0, 3) ~= "../")) {
    if (n.length < 3) {
      return true;
    } else {
      return $$String.sub(n, 0, 3) ~= "..\\";
...
function has_drive(s) {
  ...
  if (s.length >= 2 and is_letter(Caml_string.get(s, 0))) {
...
function concat(dirname, filename) {
  ...
  if (l == 0 or Curry._2(is_dir_sep$2, dirname, l - 1 | 0)) {
...
function extension_len(name) {
  ...
  while(true) {
    var i = _i;
    if (i < 0 or Curry._2(is_dir_sep$2, name, i)) {
      return 0;
      ...
      while(true) {
        var i$1 = _i$1;
        if (i$1 < 0 or Curry._2(is_dir_sep$2, name, i$1)) {
          return 0;
