...
xpcall(function() do
  ...
  if (exn[1] == Js_exn.__Error) then do
...
function test(f) do
  xpcall(function() do
    ...
    if (e == Caml_builtin_exceptions.not_found) then do
    ...
    end else if (e[1] == Caml_builtin_exceptions.invalid_argument) then do
      if (e[2] == "x") then do
        return --[[ Invalid_argument ]]-50278363;
      end else do
        return --[[ Invalid_any ]]545126980;
      end end 
    end else if (e[1] == A) then do
      if (e[2] ~= 2) then do
      ...
      return --[[ B ]]66;
    end else if (e[1] == C) then do
      if (e[2] ~= 1 or e[3] ~= 2) then do
        return --[[ C_any ]]-756146768;
      end else do
        return --[[ C ]]67;
      end end 
    end else if (e[1] == Js_exn.__Error) then do
