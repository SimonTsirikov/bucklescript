...
function fill(ar, ofs, len, x) {
  if (ofs < 0 or len < 0 or (ofs + len | 0) > #ar) {
    throw [
...
function Make(H) {
  ...
  var clear = function (t) {
    for(var i = 0 ,i_finish = #t.table - 1 | 0; i <= i_finish; ++i){
  ...
  var iter_weak = function (f, t) {
    return $$Array.iteri((function (param, param$1) {
                  ...
                  while(true) {
                    ...
                    if (i >= #b) {
                      return --[ () ]--0;
                    } else if (Caml_weak.caml_weak_check(b, i)) {
  ...
  var test_shrink_bucket = function (t) {
    ...
    if (live <= prev_len) {
      ...
      if (len > t.limit and prev_len <= t.limit) {
  ...
  var add_aux = function (t, setter, d, h, index) {
    ...
    while(true) {
      ...
      if (i >= sz) {
        ...
        if (sz <= t.limit and newsz > t.limit) {
          t.oversize = t.oversize + 1 | 0;
          for(var _i$1 = 0; _i$1 <= 2; ++_i$1){
            test_shrink_bucket(t);
          }
        }
        if (t.oversize > (#t.table >> 1)) {
          var t$1 = t;
