...
function fill(ar, ofs, len, x) do
  ...
  for var i = ofs , (ofs + len | 0) - 1 | 0 , 1 do
...
function Make(H) do
  ...
  var create = function (sz) do
    var sz$1 = sz < 7 and 7 or sz;
    var sz$2 = sz$1 > Sys.max_array_length and Sys.max_array_length or sz$1;
    return do
