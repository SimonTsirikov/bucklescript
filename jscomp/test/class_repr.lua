...
function x_init(__class) do
  ...
  get_x = ids[1];
  x = ids[2];
  CamlinternalOO.set_method(__class, get_x, (function(self_2) do
          return self_2[x];
        end end));
  return (function(env, self, v_1) do
      self_1 = CamlinternalOO.create_object_opt(self, __class);
...
function xx_init(__class) do
  ...
  CamlinternalOO.set_methods(__class, {
        ...
        (function(self_3) do
            ...
            copy[money] = 2 * self_3[x] + Curry._1(self_3[1][get_money], self_3);
            return copy;
          end end)
      });
...
function point_init(__class) do
  ...
  CamlinternalOO.set_methods(__class, {
        ...
        get_x5,
        (function(self_4) do
            return Curry._1(self_4[1][get_x], self_4) + 5 | 0;
          end end)
      });
...
function xx0_init(__class) do
  ...
  CamlinternalOO.set_methods(__class, {
        ...
        incr,
        (function(self_5) do
            copy = Caml_exceptions.caml_set_oo_id(Caml_obj.caml_obj_dup(self_5));
            copy[money] = 2 * self_5[x] + Curry._1(self_5[1][get_money], self_5);
            copy[a0] = 2;
            return copy;
          end end)
      });
