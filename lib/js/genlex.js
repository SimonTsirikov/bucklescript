...
function store(c) do
  if (bufpos.contents >= #buffer.contents) do
  ...
  var next_token = function (strm__) do
    while(true) do
      ...
      if (match ~= undefined) do
        ...
        if (c < 124) do
          var switcher = c - 65 | 0;
          if (switcher > 57 or switcher < 0) do
            if (switcher >= 58) do
              exit = 1;
            end else do
              ...
              while(true) do
                ...
                if (match$4 ~= undefined) do
                  ...
                  if (c$3 >= 91) do
                    ...
                    if (switcher$1 > 27 or switcher$1 < 0) do
                      if (switcher$1 < 97) do
                        return ident_or_keyword(get_string(--[ () ]--0));
                      end
                      
                    end else if (switcher$1 == 1) do
                      return ident_or_keyword(get_string(--[ () ]--0));
                    end
                    
                  end else if (c$3 >= 48) do
                    if (!(c$3 > 64 or c$3 < 58)) do
                      return ident_or_keyword(get_string(--[ () ]--0));
                    end
                    
                  end else if (c$3 ~= 39) do
                    return ident_or_keyword(get_string(--[ () ]--0));
                  end
