  ...
  if (len > 0) then do
    if (s1 == s2) then do
      ...
      if (i1$1 < i2$1) then do
        ...
        var range = range_a > range_b and range_b or range_a;
        for var j = range , 0 , -1 do
        ...
        var range$1 = range_a$1 > range_b$1 and range_b$1 or range_a$1;
        for var k = 0 , range$1 , 1 do
      ...
      if (len <= off1) then do
        ...
        for var i$1 = 0 , off1 - 1 | 0 , 1 do
          s2[i2 + i$1 | 0] = s1[i1 + i$1 | 0];
        end
        for var i$2 = off1 , len - 1 | 0 , 1 do
          s2[i2 + i$2 | 0] = --[ "\000" ]--0;
        end
        return --[ () ]--0;
      end end 
...
function bytes_to_string(a) do
  ...
  if (i == 0 and len <= 4096 and len == #bytes) then do
    ...
    var offset = 0;
    while(s_len > 0) do
      var next = s_len < 1024 and s_len or 1024;
