...
function map_file(fd, posOpt, kind, layout, shared, dims) do
  var pos = posOpt ~= undefined and posOpt or --[ int64 ]--[
      --[ hi ]--0,
      --[ lo ]--0
    ];
...
function of_array$1(kind, layout, data) do
  var dim1 = #data;
  var dim2 = dim1 == 0 and 0 or #Caml_array.caml_array_get(data, 0);
...
function of_array$2(kind, layout, data) do
  var dim1 = #data;
  var dim2 = dim1 == 0 and 0 or #Caml_array.caml_array_get(data, 0);
  var dim3 = dim2 == 0 and 0 or #Caml_array.caml_array_get(Caml_array.caml_array_get(data, 0), 0);
