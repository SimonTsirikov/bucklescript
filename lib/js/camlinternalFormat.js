    ...
    if (typeof fmt$1 == "number") then do
      ...
      do
         ...
         if ___conditional___ = 24--[ Custom ]-- then do
            for var _i = 1 , int_of_custom_arity(fmt$1[0]) , 1 do
              buffer_add_char(buf, --[ "%" ]--37);
              bprint_ignored_flag(buf, ign_flag);
...
function type_ignored_format_substitution(sub_fmtty, fmt, fmtty) do
  if (typeof sub_fmtty == "number") then do
    ...
    do
       ...
       if ___conditional___ = 12--[ Any_ty ]-- then do
          throw Type_mismatch;end end end 
       if ___conditional___ = 13--[ Reader_ty ]-- then do
          if (typeof fmtty == "number") then do
            throw Type_mismatch;
...
function fix_padding(padty, width, str) do
  ...
  var padty$1 = width < 0 and --[ Left ]--0 or padty;
  if (width$1 <= len) then do
    return str;
  end else do
    var res = Bytes.make(width$1, padty$1 == --[ Zeros ]--2 and --[ "0" ]--48 or --[ " " ]--32);
...
function fmt_ebb_of_string(legacy_behavior, str) do
  var legacy_behavior$1 = legacy_behavior ~= undefined and legacy_behavior or true;
  ...
  var parse_char_set = function (str_ind, end_ind) do
    ...
    var match = Caml_string.get(str, str_ind);
    var match$1 = match ~= 94 and --[ tuple ]--[
        str_ind,
        false
      ] or --[ tuple ]--[
        str_ind + 1 | 0,
  ...
  var parse_tag = function (is_open_tag, str_ind, end_ind) do
    try do
      ...
      var formatting = is_open_tag and --[ Open_tag ]--Block.__(0, [sub_format]) or (check_open_box(sub_fmt), --[ Open_box ]--Block.__(1, [sub_format]));
      ...
      if (exn == Caml_builtin_exceptions.not_found) then do
        ...
        var formatting$1 = is_open_tag and --[ Open_tag ]--Block.__(0, [sub_format$1]) or --[ Open_box ]--Block.__(1, [sub_format$1]);
        return --[ Fmt_EBB ]--[--[ Formatting_gen ]--Block.__(18, [
                    formatting$1,
                    match$3[0]
                  ])];
