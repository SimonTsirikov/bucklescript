...
function temp_file(temp_dirOpt, prefix, suffix) do
  var temp_dir = temp_dirOpt ~= undefined and temp_dirOpt or current_temp_dir_name.contents;
  var _counter = 0;
  while(true) do
...
function open_temp_file(modeOpt, permsOpt, temp_dirOpt, prefix, suffix) do
  var mode = modeOpt ~= undefined and modeOpt or --[ :: ]--[
      --[ Open_text ]--7,
      --[ [] ]--0
    ];
  var perms = permsOpt ~= undefined and permsOpt or 384;
  var temp_dir = temp_dirOpt ~= undefined and temp_dirOpt or current_temp_dir_name.contents;
  var _counter = 0;
  while(true) do
    var counter = _counter;
