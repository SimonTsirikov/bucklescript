        ...
        while(true) do
          ...
          if (n$1 < 0) do
            ...
            while(true) do
              ...
              if (n$2 < 0) do
                return $$String.sub(name, 0, 1);
              end else if (Curry._2(is_dir_sep, name, n$2)) do
                _n$2 = n$2 - 1 | 0;
                continue ;
              end else do
...
function is_implicit(n) do
  if (is_relative(n) and (#n < 2 or $$String.sub(n, 0, 2) ~= "./")) do
    if (#n < 3) do
      return true;
    end else do
...
function is_relative$1(n) do
  if ((#n < 1 or Caml_string.get(n, 0) ~= --[ "/" ]--47) and (#n < 1 or Caml_string.get(n, 0) ~= --[ "\\" ]--92)) do
    if (#n < 2) do
      return true;
    end else do
...
function is_implicit$1(n) do
  if (is_relative$1(n) and (#n < 2 or $$String.sub(n, 0, 2) ~= "./") and (#n < 2 or $$String.sub(n, 0, 2) ~= ".\\") and (#n < 3 or $$String.sub(n, 0, 3) ~= "../")) do
    if (#n < 3) do
      return true;
    end else do
      return $$String.sub(n, 0, 3) ~= "..\\";
...
function has_drive(s) do
  ...
  if (#s >= 2 and is_letter(Caml_string.get(s, 0))) do
...
function concat(dirname, filename) do
  var l = #dirname;
  if (l == 0 or Curry._2(is_dir_sep$2, dirname, l - 1 | 0)) do
...
function extension_len(name) do
  ...
  while(true) do
    var i = _i;
    if (i < 0 or Curry._2(is_dir_sep$2, name, i)) do
      return 0;
    end else if (Caml_string.get(name, i) == --[ "." ]--46) do
      var i0 = i;
      var _i$1 = i - 1 | 0;
      while(true) do
        var i$1 = _i$1;
        if (i$1 < 0 or Curry._2(is_dir_sep$2, name, i$1)) do
          return 0;
        end else if (Caml_string.get(name, i$1) == --[ "." ]--46) do
          _i$1 = i$1 - 1 | 0;
          continue ;
        end else do
          return #name - i0 | 0;
...
function temp_file(temp_dirOpt, prefix, suffix) do
  ...
  while(true) do
    ...
    try do
      ...
      if (e[0] == Caml_builtin_exceptions.sys_error) do
        if (counter >= 1000) do
          throw e;
        end
