...
function restricted_point_init(__class) do
  ...
  CamlinternalOO.set_methods(__class, {
        ...
        bump,
        (function(self_1) do
            return Curry._2(self_1[1][move], self_1, 1);
          end end)
      });
...
function restricted_point_prime_init(__class) do
...
restricted_point_prime = CamlinternalOO.make_class(shared_2, restricted_point_prime_init);

function restricted_point2_prime_init(__class) do
  inh = CamlinternalOO.inherits(__class, 0, 0, shared_2, restricted_point, true);
  obj_init = inh[1];
  return (function(env, self, x) do
      return Curry._2(obj_init, self, x);
...
restricted_point2_prime = CamlinternalOO.make_class(shared_2, restricted_point2_prime_init);

Point = {
  restricted_point_prime = restricted_point
};
...
function abstract_point_001(__class) do
  ...
  get_x = ids[2];
  get_offset = ids[3];
  CamlinternalOO.set_method(__class, get_offset, (function(self_5) do
          return Curry._1(self_5[1][get_x], self_5) - self_5[x_init] | 0;
        end end));
  return (function(env, self, x_init_1) do
      self_1 = CamlinternalOO.create_object_opt(self, __class);
      self_1[x_init] = x_init_1;
...
function colored_point_init(__class) do
  ...
  obj_init = inh[1];
  CamlinternalOO.set_method(__class, color, (function(self_7) do
          return self_7[c_1];
        end end));
...
p_prime = Curry._3(colored_point[1], 0, 5, "red");

eq("File \"class4_test.ml\", line 67, characters 5-12", --[[ tuple ]]{
      5,
      "red"
    }, --[[ tuple ]]{
      Caml_oo_curry.js1(291546447, 1, p_prime),
      Caml_oo_curry.js1(-899911325, 2, p_prime)
    });
...
eq("File \"class4_test.ml\", line 71, characters 12-19", 6, get_succ_x(p_prime));
...
exports.restricted_point_prime = restricted_point_prime;
exports.restricted_point2_prime = restricted_point2_prime;
exports.Point = Point;
exports.abstract_point = abstract_point;
exports.point = point;
exports.colored_point = colored_point;
exports.p_prime = p_prime;
