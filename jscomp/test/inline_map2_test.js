...
function Make(Ord) do
  ...
  var for_all = function (p, _param) do
    while(true) do
      var param = _param;
      if (param) do
        if (Curry._2(p, param[1], param[2]) and for_all(p, param[0])) do
          _param = param[3];
          continue ;
        end else do
          return false;
  ...
  var exists = function (p, _param) do
    while(true) do
      var param = _param;
      if (param) do
        if (Curry._2(p, param[1], param[2]) or exists(p, param[0])) do
          return true;
        end else do
          _param = param[3];
          continue ;
  ...
  var equal = function (cmp, m1, m2) do
    ...
    while(true) do
      ...
      var e1 = _e1;
      if (e1) do
        if (e2 and Curry._2(Ord.compare, e1[0], e2[0]) == 0 and Curry._2(cmp, e1[1], e2[1])) do
          _e2 = cons_enum(e2[2], e2[3]);
          _e1 = cons_enum(e1[2], e1[3]);
          continue ;
        end else do
...
function for_all$1(p, _param) do
  while(true) do
    var param = _param;
    if (param) do
      if (Curry._2(p, param[1], param[2]) and for_all$1(p, param[0])) do
        _param = param[3];
        continue ;
      end else do
        return false;
...
function exists$1(p, _param) do
  while(true) do
    var param = _param;
    if (param) do
      if (Curry._2(p, param[1], param[2]) or exists$1(p, param[0])) do
        return true;
      end else do
        _param = param[3];
        continue ;
